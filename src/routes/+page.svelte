<script lang="ts">
  ...
  export let url = "https://qrixie.com"
</script>
...
<svelte:head>
	...
	<meta name="description" content="QRixie - The free QR generator" />
			...
			<!-- Section - Intro -->
			<section class="flex flex-wrap items-center content-center h-screen snap-start">
        <div class='w-1/2'>
          ...
          <h2 class="text-fadedwhite text-4xl md:text-6xl font-bold tracking-wider">The Free QR Code Generator</h2>
          ...
          <input bind:value={url} type='text' class='bg-[#8892AF] text-black px-2 py-1 w-full' placeholder="Enter a URL">
        </div>
        <div class='w-1/2'>
          <img
            use:qr={{
